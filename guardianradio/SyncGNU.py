...
# Title: Syncgnu
# Generated: Thu Mar 11 11:16:46 2021
##################################################
...
class SyncGNU(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Syncgnu")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Syncgnu")
        ...
        self.settings = Qt.QSettings("GNU Radio", "SyncGNU")
        ...
        self.file_source_block = blocks.file_source(gr.sizeof_gr_complex*1, '/home/meach/Documents/Capstone/GNUradio/Sig2405G2SR/shortsync2405g2SPs..dll', False)
        ...
        self.connect((self.file_source_block, 0), (self.blocks_multiply_const_vxx_0, 0))
...
def main(top_block_cls=SyncGNU, options=None):
